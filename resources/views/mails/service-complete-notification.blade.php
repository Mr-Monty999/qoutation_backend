        ...
        <div style="width: 100%; max-width: 489px; margin: 0 auto">
            ...
            <div style="width: 100%; max-width: 489px; margin: 0 auto">
                ...
                <div style="margin: 0;font-weight:bold;font-size:20px;color:black">
                    <a href="{{ env('FRONTEND_URL') . '/user/services/' . $data['service_id'] . '/replies/' . $data['service_reply_id'] . '/edit' }}"
                        target="_blank">
                        {{ env('FRONTEND_URL') . '/user/services/' . $data['service_id'] . '/replies/' . $data['service_reply_id'] . '/edit' }}</a>
                </div>
